...
const streamingSticks: DeviceSpec[] = [
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/amazon-fire-tv-stick-4k-max', quote: 'An excellent streamer and the best Fire TV Stick yet, the Fire TV Stick 4K Max offers plenty of entertainment options, the super-helpful Alexa and terrific streaming performance.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/amazon-fire-tv-stick-4k-max', quote: 'The Fire TV Stick 4K Max delivers plenty of entertainment options, the super-helpful Alexa companion and flawless streaming performance' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/amazon-fire-tv-stick-4k', quote: 'Amazon\'s newly revealed Fire Stick 4K is the first dongle in its range to offer Ultra HD visuals and HDR support. Is it the streamer to beat in 2018?' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'theverge.com review', url: 'https://www.theverge.com/2018/10/31/18044584/amazon-fire-tv-stick-4k-review', quote: 'After spending a few days reviewing Amazons latest, its an easy recommendation. But unless youre already someone using Alexa daily, I dont think theres anything that makes it the definitive choice.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/amazon-fire-tv-stick', quote: 'Amazon\'s newly revealed Fire Stick 4K is the first dongle in its range to offer Ultra HD visuals and HDR support. Is it the streamer to beat in 2018?' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/amazon-fire-tv-stick-lite-2020', quote: '* Sound quality At the mercy of your TV again You should buy the Amazon Fire TV Stick Lite if You should not buy the Amazon Fire TV Stick Lite if' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/roku-streaming-stick-plus', quote: 'Roku\'s best streaming stick is now better value than ever. The company has dropped the price of its 4K HDR Steaming Stick Plus is now 20 off.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/chromecast-with-google-tv', quote: 'The Chromecast with Google TV is an excellent, feature packed streaming stick that matches, if not beats its Fire and Roku competition, but there are a few odd omissions.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'theverge.com review', url: 'https://www.theverge.com/23395200/chromecast-google-tv-hd-review', quote: 'You already know its video limits, but for audio, Chromecast with Google TV HD supports traditional Dolby Digital, so you can still enjoy surround sound. Just without the Atmos height channels.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'androidpctv.com review', url: 'https://androidpctv.com/review-xiaomi-mi-tv-stick-opinion/', quote: 'Xiaomi Mi TV Stick is the new Android TV Stick from Xiaomi which we present its review today. A very expected device but with a very short hardware as we will see.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techweekmag.com review', url: 'https://www.techweekmag.com/gadgets/reviews/realme-4k-smart-google-tv-stick-review-shortcut-to-google-tv/', quote: 'Realme 4K Smart Google TV Stick : Shortcut to Google TV - StereoTech' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'androidguys.com review', url: 'https://androidguys.com/reviews/accessory-reviews/mecool-kd3-tv-stick-with-google-tv/', quote: 'One of the newest avenues for Googles empire has been television. While its already seen an odd progression that Google is notorious for, the latest reboot with Google TV is slowly making it to other devices. One such device is the MeCool KD3 TV Stick. Weve spent a month with this streaming dongle and came away with mixed emotions.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'tomsguide.com review', url: 'https://www.tomsguide.com/reviews/tivo-stream-4k', quote: 'TiVo Stream 4K is an affordable streaming device with high-quality video, but it\'s not a compelling buy over rivals.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'troypoint.com review', url: 'https://troypoint.com/onn-4k-plus-review/', quote: 'The Onn 4K Plus Streaming Device is the latest budget-friendly offering from Walmart, aiming to provide a premium streaming experience without breaking the bank.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'consumerreports.org review', url: 'https://www.consumerreports.org/electronics-computers/streaming-media/onn-google-tv-full-hd-streaming-device/m413472/', quote: 'Onn Google TV Full HD Streaming Device Streaming Media Review - Consumer Reports' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'troypoint.com review', url: 'https://troypoint.com/dynalink-android-tv-box/', quote: 'This Dynalink Android TV Box Review was written by Troy from TROYPOINT after using the Android TV Box on a regular basis for three days.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'tomsguide.com review', url: 'https://www.tomsguide.com/us/google-chromecast-3rd-generation,review-5843.html', quote: 'The new Google Chromecast is fast and intuitive, but the attractive little dongle is behind the times.' },
    ],
    sources: [
...
const streamingBoxes: DeviceSpec[] = [
  {
    ...
    editorSources: [
      { label: 'inverse.com review', url: 'https://www.inverse.com/gear/apple-tv-4k-2022-review-a15-bionic-chip-siri-remote-usb-cheaper-price', quote: 'The Apple TV 4K (2022) is also a great hub for your smart home, and it connects seamlessly to other Apple devices and iCloud.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'theverge.com review', url: 'https://www.theverge.com/22454960/apple-tv-4k-2021-review', quote: 'The biggest improvement is undoubtedly the redesigned second-generation Siri Remote that comes bundled with the new Apple TV 4K - but you can buy that separately for $59.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'theverge.com review', url: 'https://www.theverge.com/2017/9/21/16341876/new-apple-tv-4k-review-2017', quote: 'But the new Apple TV doesnt support Atmos. And it doesnt support YouTube in 4K HDR. And it doesnt have Disney or Marvel movies in 4K HDR. And it makes some 1080p content look less than great.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'troypoint.com review', url: 'https://troypoint.com/nvidia-shield-tv-pro-review/', quote: '----------- The 2019 NVIDIA SHIELD TV Pro has long been awaited by streaming fans and cord-cutters since its previous version. In my opinion, the Tegra X1+ processor does a superb job of supporting the lag-free performance of the device.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/nvidia-shield', quote: '------- The Nvidia Shield TV is among the very best premium Android streaming boxes thanks to support for Dolby Vision and Dolby Atmos, while still offering users the capability to stream 4K content from popular streaming services. Add in its incredible Sta...' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'reviewed.com review', url: 'https://www.reviewed.com/televisions/content/roku-ultra-2022-review', quote: '#### Pros Top-notch voice remote pro 4K/HDR and Dolby Vision Fast, with wired internet #### Cons More expensive than streaming sticks The 2022 Roku Ultra once again proves why it\'s the best streaming device money can buy.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'tomsguide.com review', url: 'https://www.tomsguide.com/reviews/roku-ultra-lt', quote: 'The Roku Ultra LT offers the best features of Roku\'s highest-end streaming player for a reasonable price.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'troypoint.com review', url: 'https://troypoint.com/2nd-generation-fire-tv-cube-review/', quote: 'The following article is a complete Fire TV Cube Review (2nd Generation) written by Troy from TROYPOINT after several weeks of use.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'theverge.com review', url: 'https://www.theverge.com/2017/10/24/16527844/amazon-fire-tv-review-4k-2017', quote: 'Follow See All Amazon Amazon Fire TV (2017) review: everything but the content' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'pocketables.com review', url: 'https://pocketables.com/2016/10/xiaomi-mi-box-review-chromecast-ultra.html', quote: 'The unit is fast and extremely responsive. Apps load and close quickly and there are nice animations that make the whole experience feel smooth.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'androidpctv.com review', url: 'https://androidpctv.com/review-nokia-streaming-box-8000-opinion/', quote: '**Nokia Streaming Box 8000** is an interesting Android TV-Box that we present today its analysis or review.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'troypoint.com review', url: 'https://troypoint.com/formuler-z11-pro-max/', quote: 'This Formuler Z11 Pro Max Review was created by Troy after using it on a regular basis for over two weeks. This Android TV Box was purchased by Troy and' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'troypoint.com review', url: 'https://troypoint.com/formuler-z10-pro-max/', quote: 'The Formuler Z10 Pro Max is one of the best Android TV Boxes on the market today, focusing on IPTV and powerful remote control.' },
    ],
    review: {
      summary:
  ...
  },
  {
    ...
    editorSources: [
      { label: 'androidpctv.com review', url: 'https://androidpctv.com/strong-leap-s1-opinion/', quote: 'STRONG Leap-S1 new Box with all the certificates and Android TV 10 | AndroidPCtv' },
    ],
    review: {
      summary:
...
const smartTvs: DeviceSpec[] = [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/lg-oled65g3', quote: 'A mostly excellent flagship OLED TV, the LG OLED65G3 puts in fabulously bright and accomplished 4K HDR performance' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/televisions/lg-b3-review', quote: 'An excellent performing TV with a couple of setbacks' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/samsung-s90c', quote: 'Samsung is launching two new OLEDs for 2023 in the S90C and S95C. We sum up the key differences between the two televisions' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/reviews/samsung-s95c-review', quote: 'Quantum Dot OLED mark 2 is here - and it rocks' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/samsung-qe65qn85c', quote: 'Home  Samsung QE65QN85C Review Reviews Samsung QE65QN85C Review' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/sony-xr-55a80l', quote: 'It\'s arguably more of what\'s come before but it\'s hard to critique the Sony A80L when the performance is this accomplished.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/sony-a95l', quote: 'There are currently only two QD-OLED TVs announced for 2023. We compare the Sony A95L against the Samsung S95C.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/reviews/sony-x90l', quote: 'Sony\'s affordable LED 4K TV is an overachiever' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/reviews/tcl-qm8', quote: 'TCLs top mini-LED TV is a bright big-screen value' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/reviews/tcl-q7', quote: 'Why you can trust TechRadar We spend hours testing every product or service we review, so you can be sure you\'re buying the best. Find out more about how we test.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/televisions/hisense-u8k-review', quote: 'Hisenses flagship mini-LED TV flies high on value' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/hisense-65u7kqtuk', quote: 'Price and specification dont exactly match here  and thats a good thing as far as the Hisense U7K is concerned' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/reviews/vizio-p-series-quantum-x-2021', quote: 'An ultra-bright flagship 4K TV to rival Samsung\'s top QLED TVs' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/philips-oled807', quote: 'Philips has unveiled the OLED807 TV bringing a number of improvements to the table to extract even more performance' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'techradar.com review', url: 'https://www.techradar.com/reviews/panasonic-lz2000', quote: 'The Panasonic LZ2000 has four HDMI inputs at the rear, two of which support High Frame Rate 4K 120Hz video from a next-gen games console.' },
    ],
    sources: [
...
const mobileDevices: DeviceSpec[] = [
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/iphone-15-pro', quote: 'According to fresh code emerging from Apple, the iPhone 15 Pro and iPhone 15 Pro Max have received a boost to 8GB of RAM.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'consumerreports.org review', url: 'https://www.consumerreports.org/electronics-computers/cell-phones/apple-iphone-15-pro-max/m411815/', quote: 'Apple iPhone 15 Pro Max Cell Phone Review - Consumer Reports' },
    ],
    sources: [
      { label: 'Apple specs', url: 'https://www.apple.com/iphone-15-pro/specs/' },
    ],
  ...
  },
  {
    ...
    editorSources: [
      { label: 'nextpit.com review', url: 'https://www.nextpit.com/reviews/apple-iphone-15-plus-review', quote: '### Pros of the Apple iPhone 15 Plus Top-notch performance Great camera USB-C port Unrivalled software support Excellent battery life ### Cons of the Apple iPhone 15 Plus Slow display refresh rates Feature segmentation with the Pro models In a...' },
    ],
    sources: [
      { label: 'Apple specs', url: 'https://www.apple.com/iphone-15/specs/' },
    ],
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/iphone-14', quote: 'The iPhone 14 could be the last to accommodate physical SIM cards, according to a new report suggesting Apple considered getting rid this time around. According to the well-connected Bloomberg reporter Mark Gurman, Apple is making a greater push towards the use of the electronic eSIM technology. Apple already embeds them within the iPhone and' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/iphone-13', quote: 'Even almost two years after its release, the iPhone 13 still represents an excellent choice, even more so when found at a discount.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/apple-ipad-pro-m4-2024', quote: 'Is the iPad Pro M4 2024 the best tablet I have ever reviewed? Yes, there\'s no question about it.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/apple-ipad-pro-m4-2024', quote: 'The iPad Pro M4 2024 is a wonderful piece of hardware. Its the first product powered by the M4 chip, which will eventually signal Apples march towards an AI computing future. Its also not for everyone.' },
    ],
    sources: [
      { label: 'Apple specs', url: 'https://www.apple.com/ipad-pro/specs/' },
    ],
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/ipad-air-2024', quote: 'With new screen sizes, the iPad Air might seem closer to the iPad Pro than ever - but that\'s still not quite the case.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/apple-ipad-10th-gen', quote: '------- The Apple iPad 10th gen is an excellent tablet in many ways - it\'s just too expensive. The design is a massive upgrade USB-C is far more convenient than Lightning Smart front camera placement Unbeatable tablet apps and software Huge price...' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'digitalcitizen.life review', url: 'https://www.digitalcitizen.life/brief-hands-samsung-galaxy-s24-line-up/', quote: 'While you\'re watching the Samsung Galaxy Unpacked event of 2024, I have some interesting facts about the new Galaxy S24, Galaxy S24+, and Galaxy S24 Ultra that are being announced today.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/samsung-galaxy-a54-5g', quote: 'The Samsung Galaxy A54 is a solid mid-ranger that ticks most boxes - it has a great display, premium build, a decent camera setup and a large battery - but slight performance niggles and inconsistent battery life stop it from being an instant recommendation.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/google-pixel-8-pro', quote: 'Bursting with clever AI-infused software, the promise of software updates for many years to come and a camera and screen that thoroughly impress, the Google Pixel 8 Pro does a fantastic job at offering prospective buyers something a little different.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/google-pixel-8', quote: 'The Google Pixel 8 is an undeniably strong camera-focused smartphone with charming AI features and exceptional long-term software support.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/google-pixel-8a', quote: 'Even with a price rise in certain regions, the Pixel 8a remains excellent value for someone looking for a device with a great camera, pocketable design and the promise of many years of software updates.' },
    ],
    sources: [
  ...
  },
  {
    ...
    editorSources: [
      { label: 'trustedreviews.com review', url: 'https://www.trustedreviews.com/reviews/oneplus-12', quote: 'The OnePlus 12 ticks plenty of boxes, from premium display tech to capable Hasselblad-branded cameras and reliable all-day battery life. However, the hefty price hike is a tad disappointing, especially with lacklustre durability compared to similarly priced...' },
    ],
    sources: [
